...
\newcommand{\titel}{Exploration and Navigation of Latent Spaces in Generative Diffusion Models with Perceptual Evaluation of Results and Navigation Tools}
\newcommand{\artderarbeit}{Bachelorarbeit}  % {Bachelorarbeit,Masterarbeit}
\newcommand{\autor}{David Nguyen}
\newcommand{\studiengang}{Medieninformatik}  % {Informatik,Wirtschaftsinformatik,Medieninformatik}
\newcommand{\matrikelnr}{123\,4567}
\newcommand{\erstgutachter}{Prof.\,Dr.~Tobias Bocklet}
\newcommand{\zweitgutachter}{Prof.\, Moritz Schwind}
% \newcommand{\betreuer}{M.Sc.\,~Martina Schmidt}
% \newcommand{\unternehmen}{Musterfirma GmbH}
\newcommand{\logo}{figures/TH-Nuernberg-RGB.png}
\newcommand{\keywords}{latent spaces, diffusion models, artificial, generative}
...
\include{content/4_research_topic}
\include{content/5_method}
\include{content/6_tool}
\include{content/7_observations}
\include{content/8_evaluation}
\include{content/9_discussion}
\include{content/10_outlook}
